...
export default function AddToCartOverlay({ isVisible, product, quantity }: AddToCartOverlayProps) {
  ...
  return (
    ...
    >
      <div className="iktara-gradient relative rounded-tl-[8px] rounded-tr-[8px] size-full shadow-2xl">
        <div className="absolute iktara-gradient h-[39px] left-0 top-[82px] w-[393px]" />
        ...
        <div className="absolute flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] left-[88px] not-italic text-[#ffffff] text-[18px] text-left text-nowrap top-[50px] translate-y-[-50%]">
          <p className="block leading-[16px] whitespace-pre text-shadow-sm">{product.name}</p>
        </div>
        
        {/* "Adding to basket:" label */}
        <div className="absolute flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] left-[88px] not-italic opacity-80 text-[#FFFD8F] text-[16px] text-left text-nowrap top-[30px] translate-y-[-50%]">
